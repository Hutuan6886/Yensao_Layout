...
const ButtonPoster: React.FC<ButtonPosterProps> = ({ children, className, isShowIcon }) => {
  ...
  return (
    <button className={cn('relative flex flex-row items-center justify-center gap-2 w-fit h-auto px-6 py-2 border border-white text-white before:contents-[""] before:absolute before:top-0 before:left-0 before:w-[0%] before:h-full before:bg-[#c58c37] before:-z-10 before:transition-all before:duration-500 hover:before:w-[100%]', className)}
